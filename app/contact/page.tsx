      ...
      <nav className="bg-white shadow-lg sticky top-0 z-50">
        ...
        <main className="flex flex-col items-center justify-center min-h-screen bg-gray-50 p-4">
            <div className="max-w-2xl w-full bg-white p-8 rounded-lg shadow-lg">
              ...
              <p className="text-gray-600 mb-4">If you have any questions, please contact <a href="mailto:nexyouth.master@gmail.com" className="text-blue-600 hover:text-blue-700 transition-colors">nexyouth.master@gmail.com</a></p>
            </div>
        </main>
        </div>
    );
